package com.tung.ms.apigateway.security;
...
import com.tung.ms.apigateway.bean.auth.BasicUserDetails;
...
public class JwtTokenProvider {
  ...
  public boolean isTokenPresentInDB(String token) {
    return true;// jwtTokenRepository.findById(token).isPresent();
  }
  ...
  public UserDetails getUserDetails(String token) {
    ...
    UserDetails userDetails = new BasicUserDetails(userName, roleList.toArray(new String[roleList.size()]));
    return userDetails;
  }
